...
function build_image() {
    ...
    retry_times_with_exponential_backoff 5 git clone https://github.com/snuyanzin/flink-docker.git --branch test --single-branch
    ...
    run_with_timeout 600 docker build --no-cache --network="host" --build-arg "BUILDKIT_DOCKERFILE_CHECK=skip=SecretsUsedInArgOrEnv" -t ${image_name} dev/${image_name}-ubuntu
