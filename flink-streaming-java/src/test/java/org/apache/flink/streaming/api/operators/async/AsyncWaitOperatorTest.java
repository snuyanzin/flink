...
public class AsyncWaitOperatorTest {
    ...
    // repro: timeout+retry with serialized async completions must still emit every timeout result
    @Test
    ...
    // always-timeout function whose blocking work runs on a single-thread executor (serialized on
    // any JDK)
