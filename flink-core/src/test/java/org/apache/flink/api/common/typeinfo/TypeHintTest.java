...
public class TypeHintTest {
    ...
    public void testTypeInfoDirect() {
        ...
        assertThat(stringInfo1.hashCode()).isEqualTo(stringInfo2.hashCode());
        assertThat(stringInfo1.equals(stringInfo2)).isTrue();
        assertThat(stringInfo1.toString()).isEqualTo(stringInfo2.toString());
        ...
        assertThat(tupleInfo).isEqualTo(generic.getTypeInfo());
    }
