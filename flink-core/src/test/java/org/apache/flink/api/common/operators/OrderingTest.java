...
public class OrderingTest {
    ...
    public void testNewOrdering() {
        ...
        assertThat(ordering.getFieldPositions()).isEqualTo(new int[] {3, 1});
        assertThat(ordering.getTypes()).isEqualTo(new Class[] {Integer.class, Long.class});
        assertThat(ordering.getFieldSortDirections()).isEqualTo(new boolean[] {true, false});
    }
}
