...
public class GroupReduceOperatorTest {
    ...
    public void testSemanticPropsWithKeySelector1() {
        ...
        assertThat(semProps.getReadFields(0)).containsExactlyInAnyOrder(2, 5, 6);
    }
    ...
    public void testSemanticPropsWithKeySelector2() {
        ...
        assertThat(semProps.getForwardingTargetFields(0, 5)).containsExactlyInAnyOrder(1, 3);
        ...
        assertThat(semProps.getReadFields(0)).containsExactlyInAnyOrder(4, 7, 8);
    }
    ...
    public void testSemanticPropsWithKeySelector6() {
        ...
        assertThat(semProps.getForwardingTargetFields(0, 5)).isEmpty();
        assertThat(semProps.getForwardingTargetFields(0, 6)).containsExactly(2);
        assertThat(semProps.getForwardingTargetFields(0, 7)).containsExactlyInAnyOrder(1, 3);
