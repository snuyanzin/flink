 ...
 * CALCITE-4554.
 *
 * <p>Lines 198 ~ 201, Flink improves error message for functions without appropriate arguments in
 * handleUnresolvedFunction.
 *
 * <p>Lines 1998 ~ 2018, Flink improves error message for functions without appropriate arguments in
 * handleUnresolvedFunction at {@link SqlValidatorImpl#handleUnresolvedFunction}.
 *
 * <p>Lines 3812 ~ 3816, Flink improves Optimize the retrieval of sub-operands in SqlCall when using
 * NamedParameters at {@link SqlValidatorImpl#checkRollUp}.
 *
 * <p>Lines 5194 ~ 5207, Flink enables TIMESTAMP and TIMESTAMP_LTZ for system time period
 * specification type at {@link org.apache.calcite.sql.validate.SqlValidatorImpl#validateSnapshot}.
 *
 * <p>Lines 5551 ~ 5557, Flink enables TIMESTAMP and TIMESTAMP_LTZ for first orderBy column in
