 ...
 *
 * <p>TODO: describe usage for row-value construction and row-type construction (SQL supports both).
 */
public class SqlRowOperator extends SqlSpecialOperator {
    ...
    public RelDataType inferReturnType(final SqlOperatorBinding opBinding) {
        ...
        /*final boolean nullable =
                recordType.getFieldList().stream().allMatch(f -> f.getType().isNullable());
