 ...
 *
 * <p>The grammar definition in SQL-2011 IWD 9075-2:201?(E) 6.1 &lt;data type&gt; is as following:
 *
 * <blockquote>
 *
 * <pre>
 ...
 * </blockquote>
 *
 * <p>As a extended syntax to the standard SQL, each field type can have a [ NULL | NOT NULL ]
 * suffix specification, i.e. Row(f0 int null, f1 varchar not null). The default is NOT NULL(not
 * nullable).
 */
