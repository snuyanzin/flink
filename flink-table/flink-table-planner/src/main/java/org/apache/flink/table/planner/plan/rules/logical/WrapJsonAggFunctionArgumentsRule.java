...
public class WrapJsonAggFunctionArgumentsRule
    ...
    public static final RelOptRule INSTANCE =
            new WrapJsonAggFunctionArgumentsRule(WrapJsonAggFunctionArgumentsRuleConfig.DEFAULT);
    ...
    public interface WrapJsonAggFunctionArgumentsRuleConfig extends RelRule.Config {
        WrapJsonAggFunctionArgumentsRuleConfig DEFAULT =
                ImmutableWrapJsonAggFunctionArgumentsRuleConfig.builder()
                        .build()
                        .as(WrapJsonAggFunctionArgumentsRuleConfig.class)
        ...
        default WrapJsonAggFunctionArgumentsRuleConfig onJsonAggregateFunctions() {
            ...
            return withOperandSupplier(aggTransform)
                    .as(WrapJsonAggFunctionArgumentsRuleConfig.class);
        }
    }
}
