 ...
 * }</pre>
 */
public class PushLocalHashAggIntoScanRule
        extends PushLocalAggIntoScanRuleBase<PushLocalHashAggIntoScanRule.Config> {
    public static final PushLocalHashAggIntoScanRule INSTANCE =
            new PushLocalHashAggIntoScanRule(Config.DEFAULT);

    public PushLocalHashAggIntoScanRule(Config config) {
        super(config);
    }

    /** Config for PushLocalHashAggIntoScanRule. */
                                                                                ...
                                                                                b2 ->
                                                                                        b2.operand(
                                                                                                        BatchPhysicalTableSourceScan
                                                                                                                .class)
                                                                                                .noInputs())))
                        .withDescription("PushLocalHashAggIntoScanRule")
                        .as(Config.class);

        @Override
        default PushLocalHashAggIntoScanRule toRule() {
            return new PushLocalHashAggIntoScanRule(this);
        }
    }
