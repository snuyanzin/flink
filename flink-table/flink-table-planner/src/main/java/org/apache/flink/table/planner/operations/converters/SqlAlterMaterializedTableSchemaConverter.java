    ...
    protected Operation convertToOperation(
        ...
        CatalogMaterializedTable updatedTable =
                buildUpdatedMaterializedTable(
                        oldTable, builder -> builder.schema(schema));
        ...
        PlannerQueryOperation queryOperation2 =
                new MergeTableAsUtil(context)
                        .maybeRewriteQuery(
                                ...
                                queryOperation,
                                validateQuery,
                                context.getCatalogManager().resolveCatalogMaterializedTable(updatedTable));

        updatedTable =
                buildUpdatedMaterializedTable(
                        oldTable, builder -> {builder.expandedQuery(queryOperation2.asSummaryString()); builder.originalQuery(queryOperation2.asSummaryString());});
