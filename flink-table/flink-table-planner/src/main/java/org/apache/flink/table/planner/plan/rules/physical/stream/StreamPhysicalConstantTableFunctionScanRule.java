 ...
 * [[StreamPhysicalCorrelate]] / \ empty [[StreamPhysicalValues]] [[FlinkLogicalTableFunctionScan]]
 * }}}.
 *
 * <p>Add the rule to support select from a UDF directly, such as the following SQL: SELECT * FROM
 * LATERAL TABLE(func()) as T(c)
 *
 * <p>Note: [[StreamPhysicalCorrelateRule]] is responsible for converting a reasonable physical plan
...
public class StreamPhysicalConstantTableFunctionScanRule
    ...
    /** Holder for StreamPhysicalConstantTableFunctionScanRule. */
    public static class StreamPhysicalConstantTableFunctionScanRuleHolder {
