...
public class PreValidateReWriter extends SqlBasicVisitor<Void> {
     ...
     * @return Rowtype
     */
    public static RelDataType createTargetRowType(
    ...
    public static void validateUnsupportedCompositeColumn(SqlIdentifier id) {
        assert (id != null);
        if (!id.isSimple()) {
    ...
    public static String notSupported(SqlNode source) {
    ...
    public static CalciteContextException newValidationError(
