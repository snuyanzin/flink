 ...
 * join inputs by [[FlinkFilterJoinRule]].
 *
 * <p>For example, there is a join query (table A join table B): {{{ SELECT * FROM A, B WHERE A.f1 =
 * B.f1 AND ((A.f2 = 'aaa1' AND B.f2 = 'bbb1') OR (A.f2 = 'aaa2' AND B.f2 = 'bbb2')) }}}
 *
 ...
 *
 * <p>After join condition dependent optimization, the query will be: {{{ SELECT * FROM A, B WHERE
 * A.f1 = B.f1 AND ((A.f2 = 'aaa1' AND B.f2 = 'bbb1') OR (A.f2 = 'aaa2' AND B.f2 = 'bbb2')) AND
 * (A.f2 = 'aaa1' OR A.f2 = 'aaa2') AND (B.f2 = 'bbb1' OR B.f2 = 'bbb2') }}}.
 *
...
// (operand(classOf[LogicalJoin], any()), "JoinDependentConditionDerivationRule") {
