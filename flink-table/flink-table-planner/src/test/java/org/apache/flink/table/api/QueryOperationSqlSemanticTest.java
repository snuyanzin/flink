...
public class QueryOperationSqlSemanticTest extends SemanticTestBase {
    ...
    public List<TableTestProgram> programs() {
        return Arrays.asList(
                ...
                QueryOperationTestPrograms.WINDOW_TVF_TUMBLE_QUERY_OPERATION,
                QueryOperationTestPrograms.WINDOW_TVF_HOP_QUERY_OPERATION,
                QueryOperationTestPrograms.WINDOW_TVF_CUMULATE_QUERY_OPERATION,
                QueryOperationTestPrograms.WINDOW_TVF_SESSION_QUERY_OPERATION,
                QueryOperationTestPrograms.WINDOW_TVF_SESSION_PARTITION_QUERY_OPERATION,
