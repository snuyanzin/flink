...
import static org.apache.flink.table.catalog.TableChange.add;
import static org.apache.flink.table.catalog.TableChange.dropColumn;
import static org.apache.flink.table.catalog.TableChange.modifyColumnPosition;
    ...
    private static Collection<TestSpec> input() {
        return List.of(
                ...
                TestSpec.of(
                        ...
                        List.of(
                                add(physical("a2", DataTypes.STRING()).withComment("comment 2")),
                                dropColumn("a"))),
                TestSpec.of(
                        schema(physical("a", DataTypes.INT())),
                        schema(physical("b", DataTypes.INT())),
                        List.of(add(physical("b", DataTypes.INT())), dropColumn("a"))),
                TestSpec.of(
