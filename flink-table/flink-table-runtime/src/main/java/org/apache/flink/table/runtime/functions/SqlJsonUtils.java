...
public class SqlJsonUtils {
    ...
    /** Like {@link #jsonValue} but accepts a pre-parsed context from {@link #jsonParse}. */
    public static Object jsonValueParsed(
            Object parsedInput,
            String pathSpec,
            JsonValueOnEmptyOrError emptyBehavior,
            Object defaultValueOnEmpty,
            ...
            Object defaultValueOnError) {
        return jsonValue(
                jsonApiCommonSyntax((JsonValueContext) parsedInput, pathSpec),
                emptyBehavior,
                defaultValueOnEmpty,
                errorBehavior,
                defaultValueOnError);
     ...
     * #jsonValueParsed} or {@link #jsonQueryParsed} to avoid re-parsing the same JSON string
     * multiple times.
     */
