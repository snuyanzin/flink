...
public abstract class AbstractTestBaseJUnit5 {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(AbstractTestBaseJUnit5.class);
    ...
    public File createAndRegisterTempFile(String fileName) throws IOException {
        return Files.createTempDirectory(tmpDir, "prefix").resolve(fileName).toFile();
    }
}
