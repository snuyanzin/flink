...
public class HybridSourceITCase extends TestLogger {
    ...
    @Test
    public void testHybridSource(@InjectMiniCluster MiniCluster miniCluster) throws Exception {
    ...
    @Test
    public void testHybridSourceWithDynamicSwitchPosition(
    ...
    @Test
    public void testHybridSourceWithTaskManagerFailover(@InjectMiniCluster MiniCluster miniCluster)
            throws Exception {
    ...
    @Test
    public void testHybridSourceWithJobManagerFailover(@InjectMiniCluster MiniCluster miniCluster)
            throws Exception {
